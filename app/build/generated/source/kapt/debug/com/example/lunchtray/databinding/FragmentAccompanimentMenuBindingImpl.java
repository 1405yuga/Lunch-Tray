...
public class FragmentAccompanimentMenuBindingImpl extends FragmentAccompanimentMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.fragmentAccompaniment == variableId) {
            setFragmentAccompaniment((com.example.lunchtray.ui.order.AccompanimentMenuFragment) variable);
        }
    ...
    public void setFragmentAccompaniment(@Nullable com.example.lunchtray.ui.order.AccompanimentMenuFragment FragmentAccompaniment) {
        this.mFragmentAccompaniment = FragmentAccompaniment;
        synchronized(this) {
            mDirtyFlags |= 0x4L;
        }
        notifyPropertyChanged(BR.fragmentAccompaniment);
        super.requestRebind();
    }
    ...
    protected void executeBindings() {
        ...
        boolean viewModelMenuItemsPicklesEqualsViewModelAccompaniment = false;
        java.lang.String viewModelMenuItemsPicklesGetFormattedPrice = null;
        com.example.lunchtray.ui.order.AccompanimentMenuFragment fragmentAccompaniment = mFragmentAccompaniment;
        java.util.Map<java.lang.String,com.example.lunchtray.model.MenuItem> viewModelMenuItems = null;
        boolean viewModelMenuItemsBreadEqualsViewModelAccompaniment = false;
        ...
        boolean viewModelMenuItemsBerriesEqualsViewModelAccompaniment = false;
        ...
        if ((dirtyFlags & 0x1bL) != 0) {
            ...
            if ((dirtyFlags & 0x19L) != 0) {
                    ...
                    if (viewModelMenuItemsBread != null) {
                        // read viewModel.menuItems["bread"].equals(viewModel.accompaniment.getValue())
                        viewModelMenuItemsBreadEqualsViewModelAccompaniment = viewModelMenuItemsBread.equals(viewModelAccompanimentGetValue);
                    }
                    if (viewModelMenuItemsPickles != null) {
                        // read viewModel.menuItems["pickles"].equals(viewModel.accompaniment.getValue())
                        viewModelMenuItemsPicklesEqualsViewModelAccompaniment = viewModelMenuItemsPickles.equals(viewModelAccompanimentGetValue);
                    }
                    if (viewModelMenuItemsBerries != null) {
                        // read viewModel.menuItems["berries"].equals(viewModel.accompaniment.getValue())
                        viewModelMenuItemsBerriesEqualsViewModelAccompaniment = viewModelMenuItemsBerries.equals(viewModelAccompanimentGetValue);
                    }
        ...
        if ((dirtyFlags & 0x19L) != 0) {
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.berries, viewModelMenuItemsBerriesEqualsViewModelAccompaniment);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.bread, viewModelMenuItemsBreadEqualsViewModelAccompaniment);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.pickles, viewModelMenuItemsPicklesEqualsViewModelAccompaniment);
        }
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        switch(sourceId) {
            case 4: {
                ...
                // fragmentAccompaniment != null
                boolean fragmentAccompanimentJavaLangObjectNull = false;
                // fragmentAccompaniment
                com.example.lunchtray.ui.order.AccompanimentMenuFragment fragmentAccompaniment = mFragmentAccompaniment;



                fragmentAccompanimentJavaLangObjectNull = (fragmentAccompaniment) != (null);
                if (fragmentAccompanimentJavaLangObjectNull) {


                    fragmentAccompaniment.cancelOrder();
                }
                break;
            }
            case 2: {
            ...
            case 5: {
                ...
                if (fragmentAccompanimentJavaLangObjectNull) {
                    ...
                    fragmentAccompaniment.goToNextScreen();
                }
                break;
            }
            case 3: {
    ...
    /* flag mapping
        ...
        flag 2 (0x3L): fragmentAccompaniment
