...
public class FragmentSideMenuBindingImpl extends FragmentSideMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.fragmentSideMenu == variableId) {
            setFragmentSideMenu((com.example.lunchtray.ui.order.SideMenuFragment) variable);
        }
    ...
    public void setFragmentSideMenu(@Nullable com.example.lunchtray.ui.order.SideMenuFragment FragmentSideMenu) {
        this.mFragmentSideMenu = FragmentSideMenu;
        synchronized(this) {
            mDirtyFlags |= 0x4L;
        }
        notifyPropertyChanged(BR.fragmentSideMenu);
        super.requestRebind();
    }
    ...
    protected void executeBindings() {
        ...
        boolean viewModelMenuItemsSaladEqualsViewModelSide = false;
        ...
        boolean viewModelMenuItemsPotatoesEqualsViewModelSide = false;
        ...
        boolean viewModelMenuItemsRiceEqualsViewModelSide = false;
        com.example.lunchtray.model.MenuItem viewModelMenuItemsSalad = null;
        boolean viewModelMenuItemsSoupEqualsViewModelSide = false;
        ...
        com.example.lunchtray.ui.order.SideMenuFragment fragmentSideMenu = mFragmentSideMenu;
        ...
        if ((dirtyFlags & 0x1bL) != 0) {
            ...
            if ((dirtyFlags & 0x1aL) != 0) {
                ...
                if ((dirtyFlags & 0x18L) != 0) {
                    ...
                    if (viewModelMenuItemsSalad != null) {
                        // read viewModel.menuItems["salad"].equals(viewModel.side.getValue())
                        viewModelMenuItemsSaladEqualsViewModelSide = viewModelMenuItemsSalad.equals(viewModelSideGetValue);
                    }
                    if (viewModelMenuItemsPotatoes != null) {
                        // read viewModel.menuItems["potatoes"].equals(viewModel.side.getValue())
                        viewModelMenuItemsPotatoesEqualsViewModelSide = viewModelMenuItemsPotatoes.equals(viewModelSideGetValue);
                    }
                    if (viewModelMenuItemsRice != null) {
                        // read viewModel.menuItems["rice"].equals(viewModel.side.getValue())
                        viewModelMenuItemsRiceEqualsViewModelSide = viewModelMenuItemsRice.equals(viewModelSideGetValue);
                    }
                    if (viewModelMenuItemsSoup != null) {
                        // read viewModel.menuItems["soup"].equals(viewModel.side.getValue())
                        viewModelMenuItemsSoupEqualsViewModelSide = viewModelMenuItemsSoup.equals(viewModelSideGetValue);
                    }
            }
        }
        // batch finished
        ...
        if ((dirtyFlags & 0x1aL) != 0) {
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.potatoes, viewModelMenuItemsPotatoesEqualsViewModelSide);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.rice, viewModelMenuItemsRiceEqualsViewModelSide);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.salad, viewModelMenuItemsSaladEqualsViewModelSide);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.soup, viewModelMenuItemsSoupEqualsViewModelSide);
        }
        if ((dirtyFlags & 0x19L) != 0) {
            // api target 1
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        switch(sourceId) {
            ...
            case 5: {
                // localize variables for thread safety
                // fragmentSideMenu != null
                boolean fragmentSideMenuJavaLangObjectNull = false;
                // fragmentSideMenu
                com.example.lunchtray.ui.order.SideMenuFragment fragmentSideMenu = mFragmentSideMenu;



                fragmentSideMenuJavaLangObjectNull = (fragmentSideMenu) != (null);
                if (fragmentSideMenuJavaLangObjectNull) {


                    fragmentSideMenu.cancelOrder();
                }
                break;
            }
            case 2: {
            ...
            case 6: {
                ...
                if (fragmentSideMenuJavaLangObjectNull) {
                    ...
                    fragmentSideMenu.goToNextScreen();
                }
                break;
            }
            case 1: {
